...
# Load the CSV file
df = pd.read_csv('/Users/alvise/Documents/semestre2/Demichelis-Human_Genomics/progetto/project_data/out_gatk_realignment/control.recal.csv')
...
plt.grid(True)
plt.tight_layout()
plt.savefig('/Users/alvise/Documents/semestre2/Demichelis-Human_Genomics/progetto/project_data/out_gatk_realignment/control_reported_vs_empirical_quality.png')
plt.show()
...
plt.grid(True)
plt.tight_layout()
plt.savefig('/Users/alvise/Documents/semestre2/Demichelis-Human_Genomics/progetto/project_data/out_gatk_realignment/control_machine_cycle_vs_accuracy.png')
plt.show()
...
plt.tight_layout()
plt.savefig('/Users/alvise/Documents/semestre2/Demichelis-Human_Genomics/progetto/project_data/out_gatk_realignment/control_dinucleotide_vs_accuracy.png')
plt.show()
