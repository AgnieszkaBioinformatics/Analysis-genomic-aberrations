...
folder <- "~/chg/final_project/prova/out_scnv"

cn <- read.table(file.path(folder,"scna.copynumber.calledsegments"),header=T)

pdf("~/chg/final_project/prova/out_scnv/SegPlot.pdf")
