% Before clonet 
gatk3 -T ASEReadCounter -R ../Annotations/human_g1k_v37.fasta -o Control.csv -I Control.sorted.realigned.recalibrated.bam -sites Control.het.vcf -U ALLOW_N_CIGAR_READS -minDepth 20 --minMappingQuality 20 --minBaseQuality 20
